import { Mail, FileText, Tag, Activity, type LucideIcon } from "lucide-react";
import type {
  MailboxStatus,
  ActivityItem,
  ActivityTone,
 ...
 * pricing-rule builder and the live activity feed.
 *
...
/* Quick actions now live in `DigitalOfficeClient.tsx` (3 actions, max). */
