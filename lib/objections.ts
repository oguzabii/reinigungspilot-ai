 ...
 * sales kit (/sales-kit). Tone: calm, specific, no overpromising, "KI prepares
...
export const OBJECTIONS: Objection[] = [
  {
    ...
    a: "Gut – Klarsa muss es nicht ersetzen. Der Fokus liegt auf dem Verkauf: Anfragen schneller in Offerten verwandeln, konsequent nachfassen und aktiv B2B-Kunden ansprechen. Das ergänzt ein CRM, statt es zu doppeln.",
  },
  {
  ...
  {
    q: "„KI ist mir zu unsicher.“",
    a: "Verständlich. Die KI bereitet nur vor – jeden Versand geben Sie frei. Nichts geht unkontrolliert raus, und Ihre Daten bleiben Ihre Daten.",
  },
  {
    q: "„Das ist zu teuer.“",
  ...
  },
  {
    ...
    a: "Nein, Klarsa ist ein laufender Service (Einrichtung plus monatliches Abo). So bleiben Betreuung, Optimierung und Updates enthalten. Den passenden Einstieg klären wir in einer kurzen Beratung.",
  },
];
